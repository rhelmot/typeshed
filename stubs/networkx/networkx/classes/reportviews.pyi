...
class OutEdgeView(Generic[_Node]):
    ...
    @overload
    def __call__(
        self, nbunch: NBunch[_Node], data: Literal[True], default=None
    ...
    @overload
    def __call__(
        self, nbunch: NBunch[_Node] = None, *, data: str, default: _U | None = None
    ) -> OutEdgeDataView[_Node, tuple[_Node, _Node, _U]]: ...
    @overload
    def data(self, data: Literal[False], default=None, nbunch: NBunch[_Node] = None) -> OutEdgeView[_Node]: ...
    @overload
    def data(
    ...
    @overload
    def data(
        self, data: str, default: _U | None = None, nbunch: NBunch[_Node] = None
    ) -> OutEdgeDataView[_Node, tuple[_Node, _Node, _U]]: ...
