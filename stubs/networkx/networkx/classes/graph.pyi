...
class Graph(Collection[_Node], Generic[_Node]):
    ...
    def __init__(self, incoming_graph_data: _Data[_Node] | None = None, **attr: Incomplete) -> None: ...
    ...
    def add_edge(self, u_of_edge: _Node, v_of_edge: _Node, **attr: Incomplete) -> None: ...
    def add_edges_from(self, ebunch_to_add: Iterable[_EdgePlus[_Node]], **attr: Incomplete) -> None: ...
    ...
    def copy(self, as_view: bool = ...) -> Self: ...
