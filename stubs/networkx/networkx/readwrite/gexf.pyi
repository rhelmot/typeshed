...
def write_gexf(G, path, encoding: str = ..., prettyprint: bool = ..., version: str = ...) -> None: ...
def generate_gexf(G, encoding: str = ..., prettyprint: bool = ..., version: str = ...) -> None: ...
def read_gexf(path, node_type: Incomplete | None = ..., relabel: bool = ..., version: str = ...): ...
...
class GEXFWriter(GEXF):
    ...
    attr: Incomplete = ...
    def __init__(
        self, graph: Incomplete | None = ..., encoding: str = ..., prettyprint: bool = ..., version: str = ...
    ) -> None: ...
    graph_element: Incomplete = ...
    def add_graph(self, G) -> None: ...
    def add_meta(self, G, graph_element) -> None: ...
...
class GEXFReader(GEXF):
    ...
    simple_graph: bool = ...
    def __init__(self, node_type: Incomplete | None = ..., version: str = ...) -> None: ...
    xml: Incomplete = ...
    def __call__(self, stream): ...
    timeformat: Incomplete = ...
    def make_graph(self, graph_xml): ...
    def add_node(self, G, node_xml, node_attr, node_pid: Incomplete | None = ...) -> None: ...
