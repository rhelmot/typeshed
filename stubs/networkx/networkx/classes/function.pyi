...
@overload
def set_edge_attributes(G: Graph[Incomplete], values, name: None = ...) -> None: ...
...
@overload
def selfloop_edges(
    G: Graph[_T], data: Literal[False] = False, keys: Literal[False] = ..., default: Incomplete = ...
) -> Iterable[tuple[_T, _T]]: ...
@overload
def selfloop_edges(
    G: Graph[_T], data: Literal[True] = True, keys: Literal[False] = ..., default: Incomplete = ...
...
@overload
def selfloop_edges(
    G: Graph[_T], data: Literal[False] = False, keys: Literal[True] = True, default: Incomplete = ...
) -> Iterable[tuple[_T, _T, int]]: ...
@overload
def selfloop_edges(
    G: Graph[_T], data: Literal[True] = True, keys: Literal[True] = True, default: Incomplete = ...
