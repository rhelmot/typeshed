...
@overload
def shortest_path(G: Graph[_T], source: _T, target: _T, weight: Any | None = ..., method: str = ...) -> list[_T]: ...
@overload
...
def shortest_path_length(
    G: Any, source: Any | None = ..., target: Any | None = ..., weight: Any | None = ..., method: str = ...
) -> Any: ...
def average_shortest_path_length(G: Any, weight: Any | None = ..., method: str = ...) -> Any: ...
