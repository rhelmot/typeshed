...
@overload
def set_node_attributes(G: Graph[_T], values: dict[_T, Incomplete], name: str = None) -> None: ...

# Can "Incomplete scalar value" be enforced?
@overload
def set_node_attributes(G: Graph[Incomplete], values, name: str = None) -> None: ...
@overload
...
@overload
def set_edge_attributes(G: Graph[_T], values: dict[tuple[_T, _T], Incomplete], name: str = None) -> None: ...
@overload
...
@overload
def selfloop_edges(
    G: Graph[_T], data: str = False, keys: Literal[False] = False, default: _U = None
...
@overload
def selfloop_edges(
    G: Graph[_T], data: str = False, keys: Literal[True] = True, default: _U = None
