...
class OutEdgeView(Generic[_Node]):
    ...
    @overload
    def data(self, data: Literal[False] = ..., default: Incomplete = ..., nbunch: NBunch[_Node] = ...) -> OutEdgeView[_Node]: ...
    @overload
    def data(
        self, data: Literal[True] = ..., default: Incomplete = ..., nbunch: NBunch[_Node] = ...
    ) -> OutEdgeDataView[_Node, tuple[_Node, _Node, dict[str, Incomplete]]]: ...
    @overload
    def data(
