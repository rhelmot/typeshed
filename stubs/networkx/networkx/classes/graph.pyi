...
class Graph(Collection[_Node], Generic[_Node]):
    ...
    def __init__(self, incoming_graph_data: Data[_Node] | None = None, **attr: Any) -> None: ...
    ...
    def add_edges_from(self, ebunch_to_add: Iterable[EdgePlus[_Node]], **attr: Any) -> None: ...
    def add_weighted_edges_from(
        self, ebunch_to_add: Iterable[tuple[_Node, _Node, Any]], weight: str = ..., **attr: Any
    ) -> None: ...
    ...
    @overload
    def update(
        self, edges: Graph[_Node] | Iterable[EdgePlus[_Node]] | None = ..., nodes: Iterable[_Node] | None = ...
    ) -> None: ...
    def has_edge(self, u: _Node, v: _Node) -> bool: ...
    def neighbors(self, n: _Node) -> Iterable[_Node]: ...
    edges: OutEdgeView[_Node]
    def get_edge_data(self, u: _Node, v: _Node, default: Any = ...) -> Mapping[str, Any]: ...
    def adjacency(self) -> Iterable[tuple[_Node, Mapping[_Node, Mapping[str, Any]]]]: ...
