...
@overload
def set_node_attributes(G: Graph[_T], values: dict[_T, Any], name: str = ...) -> None: ...

# Can "Any scalar value" be enforced?
@overload
def set_node_attributes(G: Graph[Any], values: Any, name: str = ...) -> None: ...
@overload
def set_node_attributes(G: Graph[_T], values: dict[_T, dict[Any, Any]], name: None = ...) -> None: ...
def get_node_attributes(G: Graph[_T], name: str) -> dict[_T, Any]: ...
@overload
def set_edge_attributes(G: Graph[_T], values: dict[tuple[_T, _T], Any], name: str = ...) -> None: ...
@overload
...
def is_negatively_weighted(G: Graph[_T], edge: tuple[_T, _T] | None = ..., weight: str | None = ...) -> Any: ...
def is_empty(G: Graph[Any]) -> bool: ...
def nodes_with_selfloops(G: Graph[_T]) -> Iterable[_T]: ...
@overload
def selfloop_edges(
    G: Graph[_T], data: Literal[False] = False, keys: Literal[False] = ..., default: Any = ...
) -> Iterable[tuple[_T, _T]]: ...
@overload
def selfloop_edges(
    G: Graph[_T], data: Literal[True] = True, keys: Literal[False] = ..., default: Any = ...
...
@overload
def selfloop_edges(
    G: Graph[_T], data: Literal[False] = False, keys: Literal[True] = True, default: Any = ...
) -> Iterable[tuple[_T, _T, int]]: ...
@overload
def selfloop_edges(
    G: Graph[_T], data: Literal[True] = True, keys: Literal[True] = True, default: Any = ...
