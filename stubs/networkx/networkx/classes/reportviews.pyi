...
class NodeView(Generic[_Node]):
    ...
    @overload
    def __call__(self, data: Literal[False] = ..., default: Any = ...) -> NodeView[_Node]: ...
    @overload
    def __call__(self, data: Literal[True] | str, default: Any = ...) -> NodeDataView[_Node]: ...
    def data(self, data: bool | str = ..., default: Any = ...) -> NodeDataView[_Node]: ...
...
class DiDegreeView(Generic[_Node]):
    def __init__(self, G: Graph[_Node], nbunch: NBunch[_Node] = ..., weight: None | bool | str = ...) -> None: ...
    def __call__(self, nbunch: NBunch[_Node] = ..., weight: None | bool | str = ...) -> DiDegreeView[_Node]: ...
...
class OutEdgeView(Generic[_Node]):
    ...
    def __contains__(self, e: Edge[_Node]) -> bool: ...
    def __getitem__(self, e: Edge[_Node]) -> dict[str, Any]: ...
    @overload
    def __call__(self, nbunch: NBunch[_Node] = ..., data: Literal[False] = ..., default: Any = ...) -> OutEdgeView[_Node]: ...
    @overload
    def __call__(
        self, *, nbunch: NBunch[_Node] = ..., data: Literal[True], default: Any = ...
    ) -> OutEdgeDataView[_Node, tuple[_Node, _Node, dict[str, Any]]]: ...
    @overload
    def __call__(
        self, nbunch: NBunch[_Node] = ..., data: str = ..., default: _U = None
    ) -> OutEdgeDataView[_Node, tuple[_Node, _Node, _U]]: ...
    @overload
    def data(self, data: Literal[False] = False, default: Any = ..., nbunch: NBunch[_Node] = ...) -> OutEdgeView[_Node]: ...
    @overload
    def data(
        self, data: Literal[True] = True, default: Any = ..., nbunch: NBunch[_Node] = ...
    ) -> OutEdgeDataView[_Node, tuple[_Node, _Node, dict[str, Any]]]: ...
    @overload
    def data(
