...
class NodeView(Generic[_Node]):
    ...
    @overload
    def __call__(self, data: Literal[False] = ..., default=...) -> NodeView[_Node]: ...
    @overload
    def __call__(self, data: Literal[True] | str, default=...) -> NodeDataView[_Node]: ...
    def data(self, data: bool | str = ..., default=...) -> NodeDataView[_Node]: ...

class NodeDataView(Generic[_Node]):
    def __init__(self, nodedict: dict[str, Incomplete], data: bool | str = ..., default=...) -> None: ...
    def __len__(self) -> int: ...
...
class OutEdgeView(Generic[_Node]):
    ...
    @overload
    def data(self, data: Literal[False] = False, default=..., nbunch: NBunch[_Node] = ...) -> OutEdgeView[_Node]: ...
    @overload
    def data(
        self, data: Literal[True] = True, default=..., nbunch: NBunch[_Node] = ...
    ) -> OutEdgeDataView[_Node, tuple[_Node, _Node, dict[str, Incomplete]]]: ...
    @overload
    def data(
