...
def degree(G: Incomplete, nbunch: Incomplete | None = ..., weight: Incomplete | None = ...) -> Incomplete: ...
...
def add_star(G_to_add_to: Incomplete, nodes_for_star: Incomplete, **attr: Incomplete) -> None: ...
def add_path(G_to_add_to: Incomplete, nodes_for_path: Incomplete, **attr: Incomplete) -> None: ...
def add_cycle(G_to_add_to: Incomplete, nodes_for_cycle: Incomplete, **attr: Incomplete) -> None: ...
...
def restricted_view(G: Incomplete, nodes: Incomplete, edges: Incomplete) -> Incomplete: ...
...
@overload
def set_node_attributes(G: Graph[Hashable], values: Incomplete, name: str = ...) -> None: ...
@overload
...
@overload
def set_edge_attributes(G: Graph[Hashable], values: Incomplete, name: None = ...) -> None: ...
...
def is_negatively_weighted(G: Graph[_T], edge: tuple[_T, _T] | None = ..., weight: str | None = ...) -> Incomplete: ...
