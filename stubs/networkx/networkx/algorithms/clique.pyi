...
def make_clique_bipartite(
    G: Graph[_Node], fpos: None = None, create_using: type[Graph[_Node]] = ..., name: None = None
) -> Graph[_Node]: ...
@overload
def make_clique_bipartite(
    G: Graph[_Node], fpos: None = None, create_using: type[DiGraph[_Node]] = ..., name: None = None
) -> DiGraph[_Node]: ...
@overload
def make_clique_bipartite(
    G: Graph[_Node], fpos: None = None, create_using: type[MultiGraph[_Node]] = ..., name: None = None
) -> MultiGraph[_Node]: ...
@overload
def make_clique_bipartite(
    G: Graph[_Node], fpos: None = None, create_using: type[MultiDiGraph[_Node]] = ..., name: None = None
) -> MultiDiGraph[_Node]: ...
